...
public class Sign_up extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        signup_username.setFont(new java.awt.Font("Palatino Linotype", 0, 24)); // NOI18N
        ...
        signup_name.setFont(new java.awt.Font("Palatino Linotype", 0, 24)); // NOI18N
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Administration/HR_manager", "Principal_and_Manager" }));
        ...
        jPasswordField1.setFont(new java.awt.Font("Palatino Linotype", 0, 24)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        new Welcome().setVisible(true); //This allows the user to go back to the welcome page.
        dispose();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try{
            ...
            String sqll = "select * from system_users where Username = ? and Password = ?";
            PreparedStatement pstmtt = conne.prepareStatement(sqll);
            pstmtt.setString(1, signup_username.getText());
            ...
            if(rs.next()){
                ...
                try{
                    ...
                    pstmt.setString(1, signup_name.getText());
                    ...
                    pstmt.setString(4, box);
                    pstmt.executeUpdate();

           new Login_screen().setVisible(true); //This allows the user to relogin to their account from the login page to validate account creation.
           dispose();
        
           conn.close();
        }
        catch(Exception e){
         JOptionPane.showMessageDialog(null, "This account already exists. Please try again.");
        }
            }
        }
        catch(Exception e){
